...
source_url: https://www.animaze.us/manual/appmanual/keybinds
---

# Keybinds controls

To customize your key binds, follow these steps:

Go to the controls **Menu**, by clicking the **settings button** in the app

![Keybinds controls in Animaze]({{ '/assets/images/pasted_image_0_1-821c2e20.png' | relative_url }} "Keybinds controls in Animaze"){: width="800" height="565"}

From here, y browse all the presets and customize them to your liking. You can reset the hotkeys back to the default settings by clicking **the reset button** at the very bottom of the list.

![Keybinds controls in Animaze]({{ '/assets/images/Animation_1_-b145d6d1.gif' | relative_url }} "Keybinds controls in Animaze"){: width="800" height="545"}
